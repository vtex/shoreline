...
import { Set, Columns, Heading } from '@vtex/admin-ui'
...
export default function ThemeAwareProps() {
  return (
    <Set
      ...
      styleOverrides={{ bg: 'light.primary', color: 'blue' }}
      fluid
    >
      <TitleColumn />
      ...
      <PropRow value="fontVariationSettings" themeKey="fontVariationSettings" />
    </Set>
  )
}

...
export const Playground: Story<FormikCheckboxProps> = (args) => {
  ...
  const schemaValidation = Yup.object({[args.name]: Yup.bool().isTrue('admin/admin-formik.error.error')})
...
export const Error = () => {
  ...
  const schemaValidationError = Yup.object({ value: Yup.bool().isFalse('admin/admin-formik.error.message')})

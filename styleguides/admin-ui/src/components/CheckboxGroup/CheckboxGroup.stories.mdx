...
The labels involved by `CheckboxGroup` are customized with `display="flex"` and `items="center"` by default. This doesn't imply that you can't override these styles.

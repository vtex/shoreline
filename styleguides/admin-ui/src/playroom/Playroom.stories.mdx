...
This component is responsible to handle the Collapsible's state and spread the props from `useCollapsible` hook for its children.
...
This component is responsible to handle basic `Toggle` state logic and spread the props to its children.

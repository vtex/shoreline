...
<p align="center" style="padding-top: 1.5rem; padding-bottom: 1.5rem;">
  Admin UI is a design system created by VTEX to help teams build a high-quality and consistent experience for Admin products.
  <br />
...
The 0.115.0 introduced a substantial amount of changes. Use the [0.115.0 release note](https://github.com/vtex/onda/releases/tag/%40vtex/admin-ui%400.115.0) to help you.
...
AdminUI is a colaborative tool! We're always looking for contributors to help us fix bugs, build new features, or improve the project documentation. If you're interested, check out our [Contributing Guide](https://admin-ui.vercel.app/contributing/onboarding) and our
[Developer Guide](https://admin-ui.vercel.app/contributing/code-styleguide)!

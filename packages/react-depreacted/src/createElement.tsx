...
import { StyleObject, useSystem } from '@vtex/onda-core'
 ...
 * <onda.div csx={{ color: 'pink' }}>Onda styled div</onda.div>
 *
 * // polymorphism
 * <onda.button as={ExternalLibButton} csx={{ bg: 'pink' }} >🦄 this is magic</onda.button>
 */
export const onda = createElement as InlineCreateComponent & HTMLAdminComponents

domElements.forEach((tag) => {
  onda[tag] = createElement(tag)
})

...
export function Sizes() {
  const [small, setOpenSmall] = useState(false)
  const [medium, setOpenMedium] = useState(false)
  const [large, setOpenLarge] = useState(false)

  return (
    <>
      <Button onClick={() => setOpenSmall(true)}>Open small</Button>
      <Modal size="small" open={small} onClose={() => setOpenSmall(false)}>
        <ModalHeader>Confirm action</ModalHeader>
        <ModalContent>{largeContent}</ModalContent>
        <ModalFooter>
          <Button onClick={() => setOpenSmall(false)}>Close</Button>
          <Button variant="primary" onClick={() => setOpenSmall(false)}>
            Ok
          </Button>
        </ModalFooter>
      </Modal>
      <Button onClick={() => setOpenMedium(true)}>Open medium</Button>
      <Modal size="medium" open={medium} onClose={() => setOpenMedium(false)}>
        <ModalHeader>Confirm action</ModalHeader>
        <ModalContent>{largeContent}</ModalContent>
        <ModalFooter>
          <Button onClick={() => setOpenMedium(false)}>Close</Button>
          <Button variant="primary" onClick={() => setOpenMedium(false)}>
            Ok
          </Button>
        </ModalFooter>
      </Modal>
      <Button onClick={() => setOpenLarge(true)}>Open large</Button>
      <Modal size="large" open={large} onClose={() => setOpenLarge(false)}>
        <ModalHeader>Confirm action</ModalHeader>
        <ModalContent>{largeContent}</ModalContent>
        <ModalFooter>
          <Button onClick={() => setOpenLarge(false)}>Close</Button>
          <Button variant="primary" onClick={() => setOpenLarge(false)}>
            Ok
          </Button>
        </ModalFooter>
      </Modal>

...
<Box
  csx={{
    width: 100,
    height: 4,
    bg: (theme) => theme.colors.orange40,
  }}
/>
...
<Box
  csx={{
    width: 100,
    height: 4,
    bg: (theme) => theme.colors.lightBlue40,
  }}
/>
...
- Use `grey40` for secondary texts, which have a lower of importance than main texts, such as captions, subtitles, descriptions, etc.
- Use `grey40` for icons colors.
...
- Use `grey20` color for the main border (cards, lines, dividers, etc.)

<Grid templateColumns="repeat(3, 1fr)" columnGap="4" rowGap="4">
  <ColorCard color="white" name="white" />
  <ColorCard color="grey05" name="grey05" />
  <ColorCard color="grey10" name="grey10" />
  <ColorCard color="grey20" name="grey20" />
  <ColorCard color="grey30" name="grey30" />
  <ColorCard color="grey40" name="grey40" />
  <ColorCard color="grey50" name="grey50" />
  <ColorCard color="grey60" name="grey60" />

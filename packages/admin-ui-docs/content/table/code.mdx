...
When using this resolver there are two things you should follow in order to work properly: Wrap the Table component with the `SelectionTree` component (Details in the example below); Avoid adding more than 25 items per page.

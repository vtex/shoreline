...
<Section direction="row" hasExplanation>

## Writing Labels

The button label should be actionable so users know exactly what to expect when clicking. Prefer verbs in the infinitive tense.
...
Learn more about how to choose between different action components.
...
Learn more about the different variants of action components.
...
Learn more about the different positions of action components within a page.
...
Learn more about the different behaviors of action components within a page.
...
Learn more about how to craft precise labels to improve button's UX writing.

...
import { designReference } from './toc'

<PageSection
id={designReference[0].id}
title={designReference[0].value}
direction="row"
>
...
<PageSection
  id={designReference[1].id}
  title={designReference[1].value}
  direction="row"
...
<PageSection
  id={designReference[2].id}
  title={designReference[2].value}
  direction="row"
...
<PageSection
  id={designReference[3].id}
  title={designReference[3].value}
...
<PageSection
  id={designReference[4].id}
  title={designReference[4].value}
...
<PageSection
  id={designReference[5].id}
  title={designReference[5].value}
...
<PageSection
  id={designReference[6].id}
  title={designReference[6].value}
...
<PageSection
  id={designReference[7].id}
  title={designReference[7].value}

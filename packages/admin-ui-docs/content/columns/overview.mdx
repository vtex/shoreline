...
<Columns>
  <Column>
    <div className={csx({ ...palette('purple'), padding: 2 })}>6 units</div>
  </Column>
  <Column>
    <div className={csx({ ...palette('teal'), padding: 2 })}>6 units</div>
  </Column>
  <Column>
    <div className={csx({ ...palette('purple'), padding: 2 })}>6 units</div>
  </Column>
...
<Columns spacing={1}>
  <Column units={3}>
    <div className={csx({ ...palette('purple'), padding: 2 })}>3 units</div>
  </Column>
  <Column units={6}>
    <div className={csx({ ...palette('teal'), padding: 2 })}>6 units</div>
  </Column>
...
<Columns space="0">
  ...
  <Column offset="both" units={3}>
    <div className={csx({ ...palette('teal'), padding: 2 })}>3 units</div>
  </Column>
  <Column units={3}>
    <div className={csx({ ...palette('purple'), padding: 2 })}>3 units</div>
  </Column>

...
<OrderedList>
  <OrderedListItem>
    Each <code>TabPanel</code> should have an <code>id</code> correspondent to the id of its <code>Tab</code>.
  </OrderedListItem>
  <OrderedListItem>
    Every <code>TabList</code> should have the <code>aria-label</code> defined to guarantee
    accessibility.
  </OrderedListItem>
</OrderedList>

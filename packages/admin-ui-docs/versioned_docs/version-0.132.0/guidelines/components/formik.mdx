---
title: Formik (deprecated)
path: /formik/
---

:::warning

admin-ui-formik is a deprecated library and it will be removed in the next release. You should use [@vtex/admin-ui-form](/next/guidelines/components/form) instead.
...
function ExampleComplete() {
  ...
  return (
    ...
    >
      <Form>
        <Stack space="3" direction="row" csx={{ marginY: 2 }}>

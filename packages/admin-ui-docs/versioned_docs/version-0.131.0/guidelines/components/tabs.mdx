...
1. Use short labels. Prefer two words maximum.
2. Use tabs in multiple places of your page hierarchy: as a top-level navigation or inside another component.
3. Avoid using icons as the single source of information to characterize tabs.
4. Do not nest tabs, the user should be always aware of where they’re standing.
5. Avoid using more than five tabs per page, or component.
6. Avoid forcing the user to alternate back-and-forth between tabs to execute an important task.

...
export default function App() {
  return (
    <Stack space="$m" fluid>
      ...
      <Alert visible variant="warning">
        Warning alert
      </Alert>
      <Alert visible variant="positive">
        Positive alert
      </Alert>
      <Alert visible variant="critical">
        Critical alert
      </Alert>
    </Stack>
  )
...
import { Box, Alert, Button } from '@vtex/admin-ui'
...
```jsx App.js
import { Stack, Alert, IconCheckCircle, Anchor } from '@vtex/admin-ui'
...
```jsx App.js
import { Box, Alert } from '@vtex/admin-ui'

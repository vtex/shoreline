...
<details>
  <summary>
    <h4>When should the items in a list be updated?</h4>
  </summary>
  <div>
    <ul>
      <li>
        Only show new items when the user explicitly triggers an action to
  ...
  <div>
    ...
    <ul>
      <li>
        Don’t update the number of results while the merchant is navigating
        between pages.
      </li>
    </ul>
  </div>

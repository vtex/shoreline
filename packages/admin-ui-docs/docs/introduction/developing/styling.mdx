...
It works as a shorthand to apply a value to one or more CSS properties, and you can use it within the `StyleObject`. I addition to the following aliases, you can also use the [Responsive Aliases](#responsive-aliases) explained further on this page.

...
>
    ...
    >
      ...
      <Box csx={{ padding: '20px' }}>
        <Flex align="stretch" direction="column" justify="space-between">
          ...
          <br />
          <Text>
            Merchants scan, sort, filter, compare, and take action on items of a
            specific object type, such as products, or record type, such as
            orders.
          </Text>
        </Flex>
      </Box>
  ...
  >
    <Box>
      <Box>
        <img src="https://user-images.githubusercontent.com/77292838/191287023-05017691-c8f0-493e-9592-00e9b626cff9.png"></img>
      </Box>
    </Box>
    <Box csx={{ padding: '20px' }}>
      <Flex align="stretch" direction="column" justify="space-between">
        ...
        <br />
        <Text tone="secondary">
          Merchants submit data to create and edit objects, like products,
          sellers or promotions. Merchants submit data to create and edit
          objects, like products, sellers.
        </Text>
      </Flex>
    </Box>
  </Flex>

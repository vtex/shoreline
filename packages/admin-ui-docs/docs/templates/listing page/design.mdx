...
<Box csx={{ border: '$neutral', padding: '20px'}}>
  <Columns>
    ...
    <Column units={10.5}>
      <Box csx={{ padding: 2 }}><a href="https://www.figma.com/file/nEoSg6f8uuwSslJhwS4AQT/Listing-Page-Template?node-id=492%3A216213" csx={{ float: 'left'}}>Listing page template</a></Box>
    </Column>
    <Column units={1}>
      <Box csx={{ padding: 2 }}><a href="https://www.figma.com/file/nEoSg6f8uuwSslJhwS4AQT/Listing-Page-Template?node-id=492%3A216213"><IconArrowUpRight csx={{ float: 'right'}} /></a></Box>
    </Column>
  </Columns>
</Box>

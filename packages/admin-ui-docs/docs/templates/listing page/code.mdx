      ...
      <PageHeader>
        <PageHeaderTop>
          ...
          <PageHeaderActions>
            <PageHeaderButton
              icon={<IconPlus />}
              onClick={() => console.log("Redirect to create item action")}
            >
              Create item
            </PageHeaderButton>
          </PageHeaderActions>
...
const DeleteConfirmationModal = ({ state }) => {
  ...
  const onError = () => {
    showToast({
      ...
      action: {
        label: "Try again",
        onClick: () => console.log("just tried again")
      }
    });
  };
...
const Filters = () => {
  ...
  return (
    <FilterGroup state={filterGroupState} csx={{ marginBottom: "$l" }}>
  ...
  return (
    <BulkActions state={state}>
      <Button
        variant="tertiary"
        icon={<IconPencil />}
        onClick={() => console.log("Should edit items")}
      >
        Edit
      </Button>
      <Button
        variant="tertiary"
        icon={<IconCopySimple />}
        onClick={() => console.log("Should clone items")}
      >
        Clone
      </Button>
      <Button
        ...
        icon={<IconTrash />}
        onClick={() => console.log("Should delete items")}
      >
        Delete
      </Button>
    </BulkActions>

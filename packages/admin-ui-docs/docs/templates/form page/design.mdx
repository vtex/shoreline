...
<Box csx={{ border: '$neutral', padding: '20px'}}>
  <Columns>
    ...
    <Column units={10.5}>
      <Box csx={{ padding: 2 }}><a href="https://www.figma.com/file/M4O0WAcWAZ7eUDPPWH6mu3/Form-Page-Template?node-id=504%3A208847&t=LucYA5v4whGFbT5q-1" csx={{ float: 'left'}}>Form page template</a></Box>
    </Column>
    <Column units={1}>
      <Box csx={{ padding: 2 }}><a href="https://www.figma.com/file/M4O0WAcWAZ7eUDPPWH6mu3/Form-Page-Template?node-id=504%3A208847&t=LucYA5v4whGFbT5q-1"><IconArrowUpRight csx={{ float: 'right'}} /></a></Box>
    </Column>
  </Columns>
</Box>

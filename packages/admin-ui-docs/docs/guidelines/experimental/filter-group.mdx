...
<PageHeader title="FilterGroup" />

[Filters](/filter/) are supposed to be used in pages or sections that display some kind of data that can be filtered. The `FilterGroup`

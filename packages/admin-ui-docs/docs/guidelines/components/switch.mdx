...
```jsx live
function Example() {
  const [toggled, setSwitch] = React.useState(false)
...
```jsx live
function Example() {
  const toggle = useSwitchState({ state: false })

  return <Switch state={toggle} label="Label" />
}
```
...
| --------- | ---------------- | --------------------------------------------------------------------------------------------------------------------------------------------- | -------- | ------- |
| label     | `string`         | The component's label                                                                                                                         | ✅       | -       |
...
| children  | `ReactNode`      | Switch button children                                                                                                                        | 🚫       | -       |

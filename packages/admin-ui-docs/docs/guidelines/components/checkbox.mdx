...
<PageSection
  ...
  explanation="To render multiple checkboxes and store the checked values in an array, you need to pass the hook return object to the checkboxes state property and define a unique value for each Checkbox."
>

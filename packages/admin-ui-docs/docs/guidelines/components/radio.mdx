...
Use the `invalid` prop to define whether the user input is invalid or not. It is up to you to define what triggers it. Additionally, you should add a `invalidText` to be displayed.
...
| helpText    | `ReactNode`   | Help text                                  | 🚫       | -       |
| invalidText | `ReactNode`   | Invalid text                               | 🚫       | -       |
| invalid     | `boolean`     | Whether the filed is invalid or not        | 🚫       | `false` |

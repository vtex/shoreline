...
2. Add placeholders to clarify the type of content that must be inserted by the user.
3. Do use the required/optional flags when necessary, but prefer using one or another.
4. Add data validation to indicate when data hasn’t been inputted correctly.

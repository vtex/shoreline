...
3. Always leave an option from the list selected by default.
4. Don't offer overlapping options, they should be clearly mutually exclusive.
5. Indicate the chosen, or default option with a “check” icon.

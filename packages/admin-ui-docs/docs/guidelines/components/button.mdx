...
<Practice bad label="For maximum legibility, a text label should remain on a single line. Find another label if you can’t do it!">
...
<Practice bad label="Avoid using two primary buttons next to each other. We recommend adding only

---
title: Contributing
path: /introduction/contributing/
---
...
- Report an issue whenever you find one. Check the [Contact us page](/introduction/contact-us).
- Share implementations built using Admin UI by creating code snippets with our [Codesandbox workspace](https://codesandbox.io/dashboard/all/examples?workspace=14dc60e3-bdf1-4ae6-b462-ec1a57bbec63).
- Improve the documentation content.
- Open a Pull Request with a fix for a known issue. Check the [Github Issues](https://github.com/vtex/admin-ui/issues) and if you are a VTEXer you can also have access to our [Jira board](https://vtex-dev.atlassian.net/jira/software/c/projects/AU/boards/660).
...
- [Share your custom component with us](https://admin-ui.vercel.app/documentation/introduction/working-with-us), so we can help you refine it according to our foundations.
- We will add the component to the [Team Components](https://www.figma.com/file/xawNtclWAYbeypb4d66VUX/Team-Components?t=cDag4xNZPr079EOV-6) repository, so other teams that need a similar solution can use it.
...
Our documentation site is built using [Docusaurus](https://docusaurus.io/), a static website generator. All of our documentation is stored in the [/docs folder](https://github.com/vtex/admin-ui/tree/main/packages/admin-ui-docs/docs) of our Github Repository.
...
3. Select the option _Create a new branch for this commit and start a pull request_.
...
- Be gender neutral. Avoid gender-specific pronouns such as _he_ or _she_, and prefer the non-binary pronoun _they_ when referring to a singular person.
...
1. `yarn`
2. `yarn lerna run build` - It builds all the packages from the repository, and without this command, the _npm_ package will not have the current changes when published.

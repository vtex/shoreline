...
- <Text csx={{ color: getColor('gray50') }}>Proposed</Text> – Example not yet validated by the Admin UI team that was contributed. The design is in the [Team Components library](https://www.figma.com/file/xawNtclWAYbeypb4d66VUX/Team-Components?t=puLDwwS7n1heCvv9-1) and the code, when it exists, is in the shared [CodeSandbox workspace](https://codesandbox.io/dashboard/sandboxes/examples). Teams should use these examples for inspiration.

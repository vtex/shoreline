...
const files = [
  ...
  getPath('components', 'drawer', 'drawer-content'),
  getPath('components', 'drawer', 'drawer-dismiss'),
  getPath('components', 'drawer', 'drawer-footer'),
  getPath('components', 'drawer', 'drawer-header'),
  getPath('components', 'drawer', 'drawer-heading'),
  getPath('components', 'drawer', 'drawer-popover'),
  getPath('components', 'drawer', 'drawer-provider'),
  getPath('components', 'drawer', 'drawer-trigger'),

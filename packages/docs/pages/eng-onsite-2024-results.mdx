...
import { stats, getWinners, getContributors } from '../__contributions__/eng-contribution-challenge'

![Introduction](/assets/eng-challenge-2024.png)

Thanks to everyone who participated, that was a great experience! See the results below:

### Winners

<br />

<ContributorList contributors={getWinners()} hidden />

### Participants

<br />

<ContributorList contributors={getContributors()} />

## Contributions

The challenge ran from Aug 22th to 28th and this is how participants contributed.

<br />

<ContributionList stats={stats} />

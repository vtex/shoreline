...
You can check the [State Management](/guides/state-management) section to understand how it works its usage.
...
Go for the [Styling section](/guides/styling/introduction) section to get a detailed information and understand how styling works in Shoreline.

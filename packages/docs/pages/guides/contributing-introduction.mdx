...
It is also responbility from the maintainer role to build solid contributors to the project. This way we can ensure that the project will be sustainable and will have a long life.
...
Once you reach this level, is open to the maintainer to invite you to be part of the maintainers team.

...
The contributions are grouped into three categories:
...
The contributor represents the project user who wants to contribute to the project. They can contribute in many ways, such as
...
So to be a maintainer you need to build a deep knowledge of the project and start to contribute, by showing that you are able to guide discussions,
propose solid solutions that are aligned with the project's goals and vision, and help the community in their contributions.
...
2. Use the #shoreline Slack channel for support

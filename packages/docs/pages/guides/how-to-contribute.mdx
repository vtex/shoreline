...
GitHub is where contributions will happen. Access the Shoreline [issues list](https://github.com/vtex/shoreline/issues) to have a general view of what is happening and open new issues.

![GitHub Issues](/assets/issues.png)

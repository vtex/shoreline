...
We have a backlog with all the issues that are ready to be implemented. By ready, we mean that the issue was already discussed, it has a proposed solution, and a maintainer approved it. Those issues are tagged with the label `status: active`.

Feel free to reach out to the maintainers through the GitHub issue if you want to volunteer to work on a specific issue.
...
[See the backlog](https://github.com/orgs/vtex/projects/61/views/1)
...
- **Summarize in a new issue:** The issue has too much information, so the maintainer
will rewrite it before moving to the backlog, adding a reference to the original one.
- **Design Handoff:** If you fixed a Figma bug, prepare the handoff following the
[guidelines](https://shoreline.vtex.com/guides/design-contribution/handoff-requirements) and post the files in the issue. For bugs restricted to Figma, a
...
Submitting a proposal means that you've already designed a solution for a problem and want to share it with the community.

![Proposal flow](/assets/feature-proposal.png)

Your proposal can have two origins:
- **You have already executed a solution for your context needs and want to start a discussion
...
the [guidelines](https://shoreline.vtex.com/guides/design-contribution/handoff-requirements) and post the files in the issue. After that, a maintainer will
...
Use the [idea](https://github.com/vtex/shoreline/issues/new/choose) template and answer important questions about the feature

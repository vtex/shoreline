...
<Callout type="warning" emoji="⚠️">
  Do not post any screenshots from app pages in issues. Always post a link for the Figma file or workspace that can be accessed only by other people from VTEX.
</Callout>

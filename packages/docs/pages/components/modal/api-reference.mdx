...
<iframe src="https://shoreline.storybook.vtex.com?path=/story/components-modal--play&full=1&shortcuts=false&singleStory=true" 
...
[View source](https://github.com/vtex/shoreline/blob/7b41b411d/packages/components/src/modal/modal.tsx#L32)

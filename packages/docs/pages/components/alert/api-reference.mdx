...
<iframe src="undefined?path=/story/components-alert--play&full=1&shortcuts=false&singleStory=true" 
...
[View source](https://github.com/vtex/shoreline/blob/c9660e191/packages/components/src/alert/alert.tsx#L22)

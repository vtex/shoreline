...
- Type: `context | display1 | display2 | display3 | display4`

- Default: `'context'`

[View source](https://github.com/vtex/shoreline/blob/0ed0a3d44/packages/components/src/heading/heading.tsx#L10)

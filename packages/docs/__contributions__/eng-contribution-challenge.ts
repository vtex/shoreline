...
export const stats: ChallengeStats = {
  participantsStats: [
    ...
    },
    {
      ...
      stats: { pulls: 1, completed: 1, issues: 0, comments: 0, rate: 1.25 },
    },
    {
    ...
    },
    {
      ...
      stats: { pulls: 0, completed: 0, issues: 2, comments: 0, rate: 1 },
    },
    {
      username: 'elleenvs-d',
      image:
        'https://avatars.githubusercontent.com/u/175859727?u=b2e3221eaa3949489c941c1fe84d5cc0a63bf6cd&v=4',
      stats: { pulls: 0, completed: 0, issues: 1, comments: 2, rate: 1 },
    },
    {
    ...
    },
    {
      ...
      stats: { pulls: 0, completed: 0, issues: 1, comments: 1, rate: 0.75 },
    },
    {
    ...
    },
    {
      ...
      stats: { pulls: 0, completed: 0, issues: 1, comments: 0, rate: 0.5 },
    },
    {
...
export function getContributor(username: string) {
  return stats.participantsStats.find(

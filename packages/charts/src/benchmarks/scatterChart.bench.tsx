...
bench(
  'renders scatter chart with 1 thousand points',
  async () => {
...
bench(
  'renders scatter chart with 5 thousand points',
  async () => {
    const { unmount } = render(
      <Chart
...
bench(
  'renders scatter chart with 10 thousand points',
  async () => {
    const { unmount } = render(
      <Chart
...
bench(
  'renders scatter chart with 30 thousand points',
  async () => {
    const { unmount } = render(
      <Chart
...
bench(
  'renders scatter chart with 50 thousand points',
  async () => {
    const { unmount } = render(
      <Chart
...
bench(
  'renders scatter chart with 100 thousand points',
  async () => {
    const { unmount } = render(
      <Chart

...
In case you need to navigate from a VTEX IO React application to a NextJS application, you should use the `useNavigation` hook from the `@vtex/raccoon-io` package to navigate to your NextJS apps.

Under the hood, the `useNavigation` hooks delegates all navigation to the Render routing system. This means that you can use it to navigate

...
The token tree is represented by the [tokens](/guides/theming/config-file#tokens) javascript object use inside the `defineConfig` function. Consider the following configuration:

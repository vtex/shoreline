...
[packages/components/src/locale/locale-provider.tsx:12](https://github.com/vtex/shoreline/blob/0b6f8d7fa/packages/components/src/locale/locale-provider.tsx#L12)

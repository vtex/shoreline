...
| Name    | Type                                                                                                                                                                |
| :------ | :------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `props` | [`PopoverDismissProps`](interfaces/PopoverDismissProps.md) & `RefAttributes`\<[`HTMLButtonElement`](https://developer.mozilla.org/docs/Web/API/HTMLButtonElement)\> |
...
export default function App() { return (<><FilterApply>Apply</FilterApply></>)}`,
  }}

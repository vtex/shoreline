...
- When it's not possible to design and implement a custom loading state, a Spinner can be used - with a short text below it or to its right explaining what is happening. For example, the Spinner could be next to the word _Indexing_ or to the text “This release is being published and may take up to 5 minutes”.

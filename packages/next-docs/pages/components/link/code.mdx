...
| Name    | Type                                                                                                                             |
| :------ | :------------------------------------------------------------------------------------------------------------------------------- |
| `props` | [`LinkProps`](props.md) & `RefAttributes`\<[`HTMLAnchorElement`](https://developer.mozilla.org/docs/Web/API/HTMLAnchorElement)\> |
...
export default function App() { return (<><Link href="https://vtex.com">Go to VTEX</Link></>)}`,
  }}

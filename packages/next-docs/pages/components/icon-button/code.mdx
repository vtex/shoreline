...
| Name    | Type                                                                                                                                   |
| :------ | :------------------------------------------------------------------------------------------------------------------------------------- |
| `props` | [`IconButtonProps`](props.md) & `RefAttributes`\<[`HTMLButtonElement`](https://developer.mozilla.org/docs/Web/API/HTMLButtonElement)\> |
...
import { IconTrash } from '@vtex/shoreline-components'
export default function App() { return (<><IconButton label="Delete"> <IconTrash /></IconButton></>)}`,
  }}

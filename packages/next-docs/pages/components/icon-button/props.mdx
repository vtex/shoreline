...
- [asChild](IconButtonProps.md#aschild)
- [children](IconButtonProps.md#children)
- [label](IconButtonProps.md#label)
- [loading](IconButtonProps.md#loading)
...
[packages/components/src/icon-button/icon-button.tsx:33](https://github.com/vtex/shoreline/blob/9b5214c2f/packages/components/src/icon-button/icon-button.tsx#L33)

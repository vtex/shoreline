...
| Name    | Type                                                                                                                                         |
| :------ | :------------------------------------------------------------------------------------------------------------------------------------------- |
| `props` | [`SimpleTableProps`](props.md)\<`T`\> & `RefAttributes`\<[`HTMLTableElement`](https://developer.mozilla.org/docs/Web/API/HTMLTableElement)\> |
...
export default function App() { return (<><SimpleTable data={[]} columsn={[]} options={{}} /></>)}`,
}}
